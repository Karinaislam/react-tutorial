      ...
      <div>
        <div className="totalMainPg">
          <div className="introTotal">
            <p className="totalHead">
              {" "}
              The Total Guide For To Be a Front-end Developer{" "}
            </p>
            ...
            <p>
              Syntax, BoxModel, Advance CSS, CSS animations, Flexbox, Media
              Queries, CSS Grid layout, CSS class
            </p>
            <p className="totalHead"> JavaScript</p>
            <p>
              Data Types, Math, Random, Date,Switch, For loop, While loop,
              Functions, Object Oriented programming, Functional Programming,
              DOM Manupulation, API, JSON, AJAX, ES2015, Arrow Function,
              Promise, Templete String
            </p>
            ...
            <p>
              Best Practice, Debugging, Interview Questions, Unit Test, WebPack,
              Type Script, SCSS, Data URI
            </p>
          </div>
        </div>
      </div>
