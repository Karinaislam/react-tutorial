      ...
      <div>
        <div className="htmlMainPageContent">
          <div className="introHtml">
            ...
            <p>
              {" "}
              The first step in anyone’s web coding journey is to learn HTML.
              Starting to learn HTML doesn’t need to be expensive or scary. The
              best way to learn Front-end Web technologies is-{" "}
            </p>
            ...
            <div>
              ...
              <div className="sectionCard">
                ...
                <p>
                  Learn HTML to develop your website in simple and easy steps
                  starting from basic to advanced concepts with examples
                  including overview, basic tags, meta tags, attributes,
                  formatting, phrase tags, comments, fonts, marquees, images,
                  links, tables, frames, lists, layouts, colors, forms etc.
                </p>

                <p>
                  First: Complete this 1 hour basic HTML crash course to have a
                  kickass start.
                </p>
