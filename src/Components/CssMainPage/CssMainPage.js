        ...
        <div className="cssMainPageContent">
          <div className="introCss">
            ...
            <p>
              ...
              web pages. S0, let's learn how does it work under the hood.{" "}
            </p>
            <div>
              ...
              <div className="sectionCard">
                ...
                <p>
                  The biggest key to understanding CSS is understanding
                  selectors. Selectors are what allows you to target specific
                  HTML elements and apply style to them. Learn CSS to develop
                  your website in simple and easy steps starting from basic to
                  advanced concepts with examples including colors, layout, and
                  fonts etc.
                </p>

                <p>
                  First, Complete this 1 hour basic CSS crash course to have a
                  kickass start.
                </p>
                ...
                <div className="Iframe">
                  ...
                  <p>
                    ...
                    <a href="https://www.youtube.com/watch?v=I9XRrlOOazo">
                      tutorials
                    </a>{" "}
                  ...
                  <div className="tuitorials_block">
                    ...
                    <iframe
                      ...
                      width="560"
                      height="315"
                      src="https://www.youtube.com/embed/7ZXsPj43heo"
                      frameborder="0"
                      gesture="media"
                      allow="encrypted-media"
                      allowfullscreen
                    ...
                    <iframe
                      ...
                      width="560"
                      height="315"
                      src="https://www.youtube.com/embed/Y8zMYaD1bz0"
                      frameborder="0"
                      gesture="media"
                      allow="encrypted-media"
                      allowfullscreen
                    ...
                    <iframe
                      ...
                      width="560"
                      height="315"
                      src="https://www.youtube.com/embed/jgw82b5Y2MU"
                      frameborder="0"
                      gesture="media"
                      allow="encrypted-media"
                      allowfullscreen
                    ...
                    <iframe
                      ...
                      width="560"
                      height="315"
                      src="https://www.youtube.com/embed/B9OZkATMbag"
                      frameborder="0"
                      gesture="media"
                      allow="encrypted-media"
                      allowfullscreen
                    ...
                    <iframe
                      ...
                      width="560"
                      height="315"
                      src="https://www.youtube.com/embed/x7tLPhnA06w"
                      frameborder="0"
                      gesture="media"
                      allow="encrypted-media"
                      allowfullscreen
